                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-slate-200 bg-slate-50/50 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                      ...
                      <th className="py-3">Extracted Medicines (OCR)</th>
                          ...
                          <td className="py-4">
                            {rx.extractedMedicines && rx.extractedMedicines.length > 0 ? (
                              <div className="flex flex-wrap gap-1 max-w-xs">
                                {rx.extractedMedicines.map((med, idx) => (
                                  <span key={idx} className="bg-slate-100 text-slate-700 font-bold px-2 py-0.5 rounded text-[9px] border border-slate-200">
                                    {med}
                                  </span>
                                ))}
                              </div>
                            ) : (
                              <span className="text-orange-600 font-bold animate-pulse text-[10px] flex items-center gap-1">
                                <Activity className="w-3 h-3 text-orange-500 shrink-0" /> OCR Reading...
                              </span>
                            )}
                          </td>
                          <td className="py-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-6 flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  <div>
                    <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">OCR Clinical Reading</span>
                    {selectedPrescription.extractedMedicines ? (
                      <div className="space-y-1.5 mt-1.5">
                        {selectedPrescription.extractedMedicines.map((med, idx) => (
                          <div key={idx} className="flex items-center gap-2 text-xs font-semibold text-slate-700 bg-slate-50 p-2 border border-slate-150 rounded-xl">
                      ...
                      <div className="flex items-center gap-2 text-orange-600 text-xs font-bold bg-orange-50 p-3 rounded-xl border border-orange-200 mt-1.5 animate-pulse">
                        <Activity className="w-4 h-4 text-orange-500 shrink-0" />
                        AI is currently processing scan composition...
                      </div>
                    )}
                  </div>
                </div>
